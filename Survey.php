  ...
  <body>
    ...
    <div id="Survey">
      ...
      <form action="Results.php" method="post">
        <label for="os"><h2>Favorite Operating System</h2></lable><br/>
        ...
        <label for="movie"><h2>Favorite Movie Genre</h2></label></br>
        ...
        <label for="movie"><h2>Favorite Pizza Topping</h2></label></br>
        ...
        <label for="movie"><h2>Major</h2></label></br>
